...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_CAPABILITY'].fields_by_name['index']._options = None
  ...
  _globals['_OWNER'].fields_by_name['module']._options = None
  _globals['_OWNER'].fields_by_name['module']._serialized_options = b'\362\336\037\ryaml:\"module\"'
  _globals['_OWNER'].fields_by_name['name']._options = None
