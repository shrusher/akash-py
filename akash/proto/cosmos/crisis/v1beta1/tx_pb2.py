...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_MSGVERIFYINVARIANT'].fields_by_name['invariant_module_name']._options = None
  ...
  _globals['_MSGVERIFYINVARIANT'].fields_by_name['invariant_route']._options = None
